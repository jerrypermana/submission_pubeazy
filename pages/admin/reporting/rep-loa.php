...
if ($_SESSION['group_session'] == 'admin') {
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-file-o"></i> Reporting Letter of Accepted (LOA)
        </h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-file-o"></i> List Letter of Accepted (LOA)</h3>
                ...
                $('#full_paper').bootstrapTable({
                        ...
                        },
                    {
...

                        {
                            ...
                            width: '10%',
                            formatter: function(value, row) {
                                return "<a href='download-loa.php?id=" + value + "''><button type='button' class='btn btn-primary'><i class='fa fa-download'></i> Download</button></a>";
