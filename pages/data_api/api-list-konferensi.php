...
include_once "../../config/koneksi.php";
   ...
   $SQL_BASE="SELECT * FROM conference ";
...
//    $ret['rows'] = mysqli_fetch_array($result);
    ...
    if($search<>''){
			//get where
			$SQL_BASE.=' WHERE ';
            $SQL_BASE.='nama_konferensi  like "%'.$search.'%" OR ';
            $SQL_BASE.='tanggal like "%'.$search.'%" OR ';
			$SQL_BASE.='penyelenggara like "%'.$search.'%" OR ';
			$SQL_BASE.='input_date like "%'.$search.'%"';
